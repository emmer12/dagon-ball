...
particlesJS("particles-js", {
  ...
  "retina_detect": true
    ...
    gsap.from('.welcome-btn',1,{x:-50},"-=1")

    
    gsap.to(".featuere-card", {
      stagger: 0.3,
      scrollTrigger: ".featuere-card", // start the animation when ".box" enters the viewport (once)
      y: -10
    });

    gsap.to('.rocket',0.5, { y:-100, yoyo:true, repeat:-1 } );
